...
@section('content')
    ...
    <div class="tab-base">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-8" aria-expanded="false">{{ translate('Campaign') }}</a>
            </li>
        </ul>
        ...
        <div class="tab-content">
            ...
            <div id="demo-lft-tab-8" class="tab-pane fade">
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{translate('Campaign')}}</h3>
                    </div>

                    <!--Horizontal Form-->
                    <!--===================================================-->
                    <form class="form-horizontal" action="{{ route('campaign_link.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="col-sm-3" for="url">{{translate('Campaign Url')}}</label>
                                <div class="col-sm-9">
                                    @php
                        $campaign_link = App\BusinessSetting::where('type', 'campaign_link')->first()->value;
                        @endphp
                                    <input type="text" value="{{$campaign_link}}" name="campaign" class="form-control">
                                </div>
                            </div>
