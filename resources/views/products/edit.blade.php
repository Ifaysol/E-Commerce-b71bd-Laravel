		...
		<form class="form form-horizontal mar-top" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
			...
			<div class="panel">
				...
				<div class="panel-body">
                    ...
                    <div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Product Code')}}</label>
						<div class="col-lg-7">
							<input type="text" class="form-control" name="qr_code" value="{{ $product->qr_code }}" placeholder="{{ translate('Product Code') }}" required>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Product Serial')}}</label>
						<div class="col-lg-7">
							<input type="number" class="form-control" name="serial" placeholder="{{ translate('Product Serial') }}" value="{{ $product->serial }}">
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Pre Sale?')}}</label>
						<div class="col-lg-7">
							<input @if($product->pre_sale == 1) checked @endif type="checkbox" class="form-control" name="pre_sale" value="1">
						</div>
					</div>
					@php
			...
			<div class="panel">
				...
				<div class="panel-body">
                    ...
                    <div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Features')}}</label>
						<div class="col-lg-9">
							<textarea class="editor" name="features">{{$product->features}}</textarea>
						</div>
					</div>
				</div>
			</div>
    				...
    				<div class="panel-body">
    					...
    					<div class="row bord-btm">
    						...
    						<div class="col-md-10">
    							...
    							<div class="form-group">
    								<label class="col-lg-2 control-label">{{translate('Shipping cost (Oustside Dhaka)')}}</label>
    								<div class="col-lg-7">
    									<input type="number" min="0" value="{{ $product->outside_shipping_cost }}" step="0.01" placeholder="{{ translate('Shipping cost') }}" name="outside_shipping_cost" class="form-control">
    								</div>
    							</div>
    						</div>
    					</div>
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Description')}}</label>
						<div class="col-lg-7">
							<textarea name="meta_description" rows="8" class="editor">{{ $product->meta_description }}</textarea>
						</div>
					</div>
					<div class="form-group">
