			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-lg-7">
							<input type="text" class="form-control" name="qr_code" placeholder="{{ translate('Product Code') }}" required>
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Product Serial')}}</label>
						<div class="col-lg-7">
							<input type="number" class="form-control" name="serial" placeholder="{{ translate('Product Serial') }}">
						</div>
					</div>
					<div class="form-group">
						<label class="col-lg-2 control-label">{{translate('Pre Sale?')}}</label>
						<div class="col-lg-7">
							<input type="checkbox" class="form-control" name="pre_sale" value="1">
						</div>
					</div>
					@php
			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-lg-9">
							<textarea class="editor" name="features"></textarea>
						</div>
					</div>
				</div>
			</div>
    					...
    					<div class="row">
    						...
    						<div class="col-md-10">
    							...
    							<div class="form-group">
    								...
    								<div class="col-lg-7">
    									<input type="number" min="0" value="0" step="0.01" placeholder="{{ translate('Shipping cost') }}" name="outside_shipping_cost" class="form-control">
    								</div>
    							</div>
    						</div>
    					</div>
