                ...
                <div class="table-responsive">
                    <table class="table table-striped mar-no">
                        ...
                        <tbody>
                            @foreach (\App\Category::all() as $key => $category)
                                @php
                                    $products = \App\Product::where('category_id', $category->id)->where('published', '!=',2)->get();
                                    $qty = 0;
    ...
    <div class="flex-col-xl flex-col-lg-6 flex-col-12">
        ...
        <div class="panel">
            <div class="pad-top text-center dash-widget">
                ...
                <!--</p>-->
                 <a href='https://www.stat-counter.org/'>stat-counter</a> <script type='text/javascript' src='https://www.freevisitorcounters.com/auth.php?id=5b8984ab366328047044d5dfd8d1e0c70f0254d9'></script>
<script type="text/javascript" src="https://freevisitorcounters.com/en/home/counter/772027/t/0"></script>
                <br>
                <a href="#" class="btn btn-primary mar-top btn-block top-border-radius-no"></a>
            </div>
        </div>
    </div>
    <div class="flex-col-xl flex-col-lg-6 flex-col-12">
