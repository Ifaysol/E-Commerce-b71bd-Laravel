            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['products.deleted'])}}">
                                        <a class="nav-link" href="{{route('products.deleted')}}">{{translate('Deleted Products')}}</a>
                                    </li>
                        ...
                        <li class="{{ areActiveRoutes(['orders.index.admin', 'orders.show','orders.index.seller', 'orders.show','presale.orders.index.admin'])}}">
                            <a href="#">
                                <i class="fa fa-cube"></i>
                                <span class="menu-title">{{translate('Orders')}}</span>
                                <i class="arrow"></i>
                            </a>
                            <ul class="collapse">
                                <li class="{{ areActiveRoutes(['orders.index.admin'])}}">
                                    <a class="nav-link" href="{{route('orders.index.admin')}}">{{translate('Inhouse orders')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['orders.index.seller'])}}">
                                    <a class="nav-link" href="{{ route('orders.index.seller') }}">{{translate('Seller orders')}}
                                    </a>
                                </li>
                                <li class="{{ areActiveRoutes(['presale.orders.index.admin'])}}">
                                    <a class="nav-link" href="{{ route('presale.orders.index.admin') }}">{{translate('Presale orders')}}
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        {{-- <li class="{{ areActiveRoutes(['orders.index.seller', 'orders.show'])}}">
                            <a class="nav-link" href="{{ route('orders.index.seller') }}">
                                <i class="fa fa-shopping-basket"></i>
                                <span class="menu-title">{{translate('Orders')}} @if($sellerorders > 0)<span class="pull-right badge badge-info">{{ $sellerorders }}</span>@endif</span>
                            </a>
                        </li> --}}
                        @endif
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['social_login.index'])}}">
                                    <a class="nav-link" href="{{ route('social_login.index') }}">{{translate('Social Media Login / SMS')}}</a>
                                </li>
