            ...
            <div class="panel-body">
                <form action="{{ route('shipping_configuration_custom.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="radio mar-btm">
                        @php
                            $dhaka = (\App\BusinessSetting::where('type', 'inside_dhaka')->first()->value;
                        ...
                        <input id="seller-shipping" class="magic-radio" type="number" name="inside_dhaka" value="{{$dhaka}}">
                        
                        <br>
                        <label for="seller-shipping">{{translate('Seller Wise Flat Shipping Cost')}}</label>
                        <input id="seller-shipping" class="magic-radio" type="number" name="outside_dhaka" value="{{$outside_dhaka}}">
                    </div>
                    <div class="">
