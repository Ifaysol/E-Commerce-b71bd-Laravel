    ...
    <div class="panel">
        ...
        <form class="form-horizontal" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">{{translate('Serial')}}</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" value="{{ $category->serial }}" name="serial" placeholder="{{translate('Serial')}}">
                    </div>
                </div>
