                                                ...
                                                <label class="aiz-megabox d-block bg-white">
                                                    ...
                                                    <span class="d-flex p-3 aiz-megabox-elem">
                                                        ...
                                                        <span class="flex-grow-1 pl-3">
                                                            ...
                                                            <div>
                                                                <span class="alpha-6">{{ translate('Email') }}:</span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control custome-control" data-live-search="true" name="country">
                                                        @foreach (\App\Country::where('status', 1)->get() as $key => $country)
                                                            <option @if($country->name == 'Bangladesh') selected @endif value="{{ $country->name }}">{{ $country->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <select class="form-control mb-3" name="shipping" required>
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3" placeholder="{{ translate('Your Email')}}" name="email" value="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
