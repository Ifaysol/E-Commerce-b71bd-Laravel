                                    ...
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('user.user_register') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <span style="position: absolute;padding: 13px;font-size: 14px;">+ 88</span>
                                                <input maxlength="11" minlength="11" style="padding-left: 40px;" type="text" class="h-auto form-control-lg form-control {{ $errors->has('mobile') ? ' is-invalid' : '' }}" value="{{ old('mobile') }}" placeholder="{{  translate('Mobile') }}" required name="mobile">
