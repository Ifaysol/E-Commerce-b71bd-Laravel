        ...
        <section class="py-3 gry-bg">
            <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mx-auto">
                                            <div class="row">
                                                ...
                                                @endif
                                                @if(\App\BusinessSetting::where('type', 'sslcommerz_sandbox')->first()->value == 1)
                                                <div class="col-6">
                                                    @php
                $subtotal = 0;
                $shipping = 0;
                ...
                @endphp
                                                    ...
                                                    <label class="payment_option mb-4 your-button-class" id="sslczPayBtn" data-toggle="tooltip" data-title="sslcommerz" token="if you have any token validation"
        postdata=""
