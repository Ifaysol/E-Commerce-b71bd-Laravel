                                ...
                                <div class="">
                                    <form class="form-default" role="form" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="form-group d-none">
                                            @if (\App\Addon::where('unique_identifier', 'otp_system')->first() != null && \App\Addon::where('unique_identifier', 'otp_system')->first()->activated)
                                                <input type="text" class="form-control h-auto form-control-lg auto_email {{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" placeholder="{{ translate('Email Or Phone')}}" name="email" id="email">
                                            @else
                                                <input type="text" class="form-control h-auto auto_email form-control-lg {{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" placeholder="{{  translate('Email') }}" name="email">
                                            @endif
                                        </div>
                                        
                                        <div class="form-group">
                                            <input type="text" class="form-control h-auto form-control-lg {{ $errors->has('mobile') ? ' is-invalid' : '' }}" placeholder="{{ translate('Email or Mobile')}}" name="mobile" id="mobile">
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    <div class="checkbox pad-btm text-left text-sm-left">
                                            ...
                                            <div class="col-md-4 col-sm-12 text-center">
                                                <a href="{{ route('user.verification') }}" class="link link-xs link--style-3">{{ translate('Varification')}}</a>
                                            </div>
