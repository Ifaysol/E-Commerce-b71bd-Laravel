                        ...
                        <form class="" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Product Code')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="qr_code" placeholder="{{ translate('Product Code') }}" required value="{{ $product->qr_code }}">
                                        </div>
                                    </div>
                                    @php
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{translate('Pre Sale?')}}</label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="checkbox" class="form-control" name="pre_sale" value="1" @if ($product->pre_sale == 1) checked @endif>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="features" rows="8" class="form-control mb-3">{{ $product->features }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                            ...
                            @if (\App\BusinessSetting::where('type', 'shipping_type')->first()->value == 'product_wise_shipping')
                                <div class="form-box bg-white mt-4">
                                    ...
                                    <div class="form-box-content p-3">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>{{ translate('Shipping Cost (Inside Dhaka)')}}</label><br><label>{{ translate('Shipping Cost (Outside Dhaka)') }}</label>
                                            </div>
                                            <div class="col-md-8">
                                                ...
                                                <input type="number" min="0" step="0.01" value="{{ $product->outside_shipping_cost }}" class="form-control mb-3" name="outside_shipping_cost" placeholder="{{ translate('Shipping Cost (Outside Dhaka)') }}">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="switch" style="margin-top:5px;">
