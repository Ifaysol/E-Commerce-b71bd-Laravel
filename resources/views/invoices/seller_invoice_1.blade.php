	        ...
	        <table style="width: 40%;margin-left:auto;" class="text-right sm-padding small strong">
		        <tbody>
			        ...
			        <tr>
			            ...
			            <td class="currency">{{ single_price($order->orderDetails->where('order_id', $order->id)->max('shipping_cost')) }}</td>
			        </tr>
			        ...
			        <tr>
			            ...
			            <td class="currency">{{ single_price($order->orderDetails->where('order_id', $order->id)->sum('price') + $order->orderDetails->where('order_id', $order->id)->max('shipping_cost') + $order->orderDetails->where('order_id', $order->id)->sum('tax')) }}</td>
			        </tr>
		        </tbody>
		    </table>
	    </div>
