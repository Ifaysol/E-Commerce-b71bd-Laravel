    ...
    <div class="panel">
        ...
        <form class="form-horizontal" action="{{ route('sellers.update', $seller->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="email">{{translate('Email Verified')}}</label>
                    <div class="col-sm-9">
                        <input type="date" placeholder="{{translate('Email Verify')}}" id="email" name="email_verified_at" class="form-control" value="{{$seller->user->email_verified_at}}">
                    </div>
                </div>
                <div class="form-group">
