                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                        <div class="card">
                            ...
                            <div class="px-5 py-3 py-lg-4">
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('user.user_register') }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <span style="position: absolute;padding: 13px;font-size: 14px;">+ 88</span>
                                                <input maxlength="11" minlength="11" type="number" style="padding-left: 40px;" type="text" class="h-auto form-control-lg form-control {{ $errors->has('mobile') ? ' is-invalid' : '' }}" value="{{ old('mobile') }}" placeholder="{{  translate('Mobile') }}" required name="mobile">
