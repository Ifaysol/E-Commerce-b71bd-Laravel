                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="qr_code" placeholder="{{ translate('Product Code') }}" required>
                                        </div>
                                    </div>
                                    @php
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="features" rows="8" class="form-control mb-3"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                            ...
                            @if (\App\BusinessSetting::where('type', 'shipping_type')->first()->value == 'product_wise_shipping')
                                <div class="form-box bg-white mt-4">
                                    ...
                                    <div class="form-box-content p-3">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>{{ translate('Shipping Cost (Inside Dhaka)') }}</label><br>
                                                <label>{{ translate('Shipping Cost (Outside Dhaka)') }}</label>
                                            </div>
                                            <div class="col-md-8">
                                                ...
                                                <input type="number" min="0" step="0.01" value="0" class="form-control mb-3" name="outside_shipping_cost" placeholder="{{ translate('Shipping Cost (Outside Dhaka)') }}">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="switch" style="margin-top:5px;">
