    ...
    <section class="home-banner-area mb-4">
        <div class="container container-lg">
            <div class="row no-gutters position-relative">
                ...
                <div class="@if($num_todays_deal > 0) col-lg-8 @else col-lg-10 @endif order-1 order-lg-0 @if(count($featured_categories) == 0) home-slider-full @endif">
                ...
                <div class="col-lg-2 d-none d-lg-block">
                    @foreach (\App\Banner::where('published', 1)->where('position', 3)->get() as $key => $banner)
                        @if ($banner != null)
                            <div class="media-banner mb-3 mb-lg-0" style="min-height: 274px;">
        ...
        <div class="container container-lg">
            <div class="row gutters-10">
                <div class="col-lg-12">
                    <div class="section-title-1 clearfix">
                        <h3 class="heading-5 strong-700 mb-0 float-left">
                            <span class="mr-4">{{translate('Shop By Brand')}}</span>
                        </h3>
                ...
                <div class="col-lg-12">
                    <div class="section-title-1 clearfix">
                        <h3 class="heading-5 strong-700 mb-0 float-left">
                            <span class="mr-4">{{translate('Top Catogories')}}</span>
                        </h3>
                        <ul class="float-right inline-links">
                            <li>
                                ...
                                <a href="{{ route('products.category', $category->slug) }}" class="bg-white border d-block c-base-2 box-2 icon-anim pl-2">
                                    <div class="row align-items-center no-gutters">
                                        <div class="mx-auto text-center">
                                            <img src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset($category->banner) }}" alt="{{ __($category->name) }}" class="img-fluid lazyload image-round mt-3">
                                        </div>
