                ...
                <div class="row no-gutters cols-xs-space cols-sm-space cols-md-space">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="product-description-wrapper">
                            ...
                            @if($detailedProduct->qr_code)
                            <p class="mb-2">
                                {{ translate('Product Code: ')}}{{  __($detailedProduct->qr_code) }}
                            </p>
                            @endif
                ...
                <div class="col-xl-3 d-none d-xl-block">
                    ...
                    <div class="seller-top-products-box bg-white sidebar-box mb-3">
                        ...
                        <div class="box-content">
                            @foreach (filter_products(\App\Product::where('user_id', $detailedProduct->user_id)->where('published', 1)->orderBy('num_of_sale', 'desc'))->limit(6)->get() as $key => $top_product)
                    ...
                    <div class="product-desc-tab bg-white">
                        <div class="tabs tabs--style-2">
                            <ul class="nav nav-tabs justify-content-center sticky-top bg-white">
                                @if($detailedProduct->features != null)
                                <li class="nav-item">
                                    <a href="#tab_default_0" data-toggle="tab" class="nav-link text-uppercase strong-600">{{ translate('Features')}}</a>
                                </li>
                                @endif
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="#tab_default_5" data-toggle="tab" class="nav-link text-uppercase strong-600">{{ translate('How to buy')}}</a>
                                </li>
                            </ul>

                            <div class="tab-content pt-0">
                                @if($detailedProduct->features != null)
                                <div class="tab-pane" id="tab_default_0">
                                    <div class="py-2 px-4">
                                        <div class="row">
                                            <div class="col-md-12">
                                ...
                                <div class="tab-pane" id="tab_default_5">
                                    <div class="py-2 px-4">
                                        আমাদের প্রোডাক্ট অর্ডার খুবই সহজ।
                                        <br>
১. আপনার পছন্দের প্রোডাক্টি কিনতে  প্রথমে  কোয়ান্টিটি ও সাইজ সিলেক্ট করুন 
 <br>
২. BUY Now এ ক্লিক করুন  এরপর কন্টিনিউ শিপিং এ যান 
 <br>
৩. এরপর আপনি চাইলে রেজিস্টার করেও কিনতে পারেন বা
     আর ও সহজ Guest  Checkout এ গিয়ে আপনার কয়েকটি বেসিক তথ্য দিন আর ইনসাইড বা আউটসাইড 
     ঢাকা সিলেক্ট করুন 
      <br>
৪. এরপর পেমেন্ট অপসন সিলেক্ট করে অর্ডার টি কনফার্ম করুন।
                    ...
                    <div class="my-4 bg-white p-3">
                        ...
                        <div class="caorusel-box arrow-round gutters-5">
                            <div class="slick-carousel" data-slick-items="3" data-slick-xl-items="2" data-slick-lg-items="3"  data-slick-md-items="2" data-slick-sm-items="1" data-slick-xs-items="1"  data-slick-rows="2">
                                @foreach (filter_products(\App\Product::where('subcategory_id', $detailedProduct->subcategory_id)->where('published', 1)->where('id', '!=', $detailedProduct->id))->limit(10)->get() as $key => $related_product)
