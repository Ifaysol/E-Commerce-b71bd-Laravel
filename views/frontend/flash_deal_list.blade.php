                        ...
                        <!-- <hr class=""> -->
                            <div class="row sm-no-gutters gutters-5">
                                ...
                                @foreach ($products as $key => $product)
                                    ...
                                    <div class="col-12 products-box-bar p-3 bg-white custom_class" style="background-image: url('{{asset('/')}}/public/{{$product->banner}}');background-position: center; background-size: cover; margin-bottom: 0;background-repeat: no-repeat;overflow: hidden;margin-bottom: 20px;">
