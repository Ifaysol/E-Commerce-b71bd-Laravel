<div class="header bg-white">
            ...
            <div class="row">
                ...
                <div class="col-5 text-right d-none d-lg-block">
                    <ul class="inline-links">
                        <li>
                            <a href="{{ route('pre_sale') }}" class="top-bar-item">{{ translate('Pre Sale')}}</a>
                        </li>
                        <li>
                            <a href="{{route('home')}}/flash-deal/campaign-taozi" class="top-bar-item">{{ translate('Campaign')}}</a>
                        </li>
                        <li>
    ...
    <div class="mobile-side-menu d-lg-none">
        ...
        <div class="side-menu-wrap opacity-0">
            <div class="side-menu closed">
                ...
                <div class="side-menu-list px-3" style="display: block;height: 100%;">
    ...
    <ul class="navbar-nav w-100">
        @foreach (\App\Category::orderBy('serial','ASC')->get() as $key => $category)
        @if(count($category->subcategories)>0)

        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle caret-float-right" href="{{ route('products.category', $category->slug) }}" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                @foreach($category->subcategories as $key => $value1)
                
                @if(count($value1->subSubCategories)>0)
                <li class="dropdown-submenu">
                    <a class="dropdown-item dropdown-toggle caret-none" href="{{ route('products.subcategory', $value1->slug) }}">{{ __($value1->name) }}</a>
                    <ul class="dropdown-menu">
                        @foreach($value1->subSubCategories as $key2 => $value2)
                        <li>
                            <a class="dropdown-item" href="{{ route('products.subsubcategory', $value2->slug) }}">{{$value2->name}}</a>
                        </li>
                ...
                @else
                    <li><a class="dropdown-item" href="{{ route('products.subcategory', $value1->slug) }}">{{ __($value1->name) }}</a></li>
                @endif
                @endforeach
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{ route('products.category', $category->slug) }}"><img class="cat-image lazyload" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset($category->icon) }}" width="13" alt="{{ __($category->name) }}">{{ __($category->name) }}</a>
        </li>
        @endif
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-lg-3 col-8">
                        <div class="d-flex">
                            ...
                            <!-- Brand/Logo -->
                            <a class="d-flex align-items-baseline navbar-brand w-100" href="{{ route('home') }}">
                                @php
                                    $generalsetting = \App\GeneralSetting::first();
                                @endphp
                                @if($generalsetting->logo != null)
                                    <img src="{{ my_asset($generalsetting->logo) }}" alt="{{ env('APP_NAME') }}">
                                    <span style="font-weight: 700;color:black;margin-left: 3px;">  {{$generalsetting->logo_beside_text}}</span>
                                @else
                ...
                <div class="row no-gutters position-relative">
                    <div class="col-lg-3 position-static">
                        <div class="category-sidebar" id="category-sidebar">
                            ...
                            <ul class="categories">
                                @foreach (\App\Category::orderBy('serial', 'ASC')->get()->take(11) as $key => $category)
                                    @php
                                        $brands = array();
                                    @endphp
