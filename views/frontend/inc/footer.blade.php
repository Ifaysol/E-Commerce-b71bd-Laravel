...
<section class="slice-sm footer-top-bar bg-white">
    <div class="container container-lg sct-inner">
                    ...
                    <div class="col text-center text-md-left">
                        ...
                        <ul class="footer-links contact-widget">
                            ...
                            <li>
                               ...
                               <span class="d-block">
                                   <a style="color:#fff;" href="mailto:{{ $generalsetting->email }}">{{ $generalsetting->email  }}</a>
                                </span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-2 col-md-4">
                    <div class="col text-center text-md-left">
                        ...
                        <ul class="footer-links">
                            ...
                            <li>
                                <img style="width: 60px;" class="ecab-logo" src="{{asset('/public/frontend/img/3839_1.jpg')}}">
                            </li>
                        </ul>
                    </div>
                </div>
