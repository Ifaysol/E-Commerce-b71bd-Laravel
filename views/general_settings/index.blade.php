        ...
        <div class="panel">
            ...
            <form class="form-horizontal" action="{{ route('generalsettings.update',$generalsetting->id ) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="name">{{translate('Logo Beside Text')}}</label>
                        <div class="col-sm-9">
                            <input type="text" id="logo_beside_text" name="logo_beside_text" value="{{ $generalsetting->logo_beside_text }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
