...
//                    }
    ...
    public function makePayment(array $requestData, $type = 'checkout', $pattern = 'json')
    {
        ...
        $this->data['store_id'] = env("STORE_ID");
        $this->data['store_passwd'] = env("STORE_PASSWD");
        if($this->data['store_id'] == null){
            $this->data['store_id'] = 'b71bdlive';
        }
        
        if($this->data['store_passwd'] == null){
            $this->data['store_passwd'] = '60508A11D139756949';
        }
        
        
        if ($this->data['cus_email'] == '') {
            $this->data['cus_email'] = 'guest@gmail.com';
        }
