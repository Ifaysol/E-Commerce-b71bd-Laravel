...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::get('/deleted-products','ProductController@deleted_products')->name('products.deleted');
	...
	Route::post('/env_key_update_sms', 'BusinessSettingsController@env_key_update_sms')->name('env_key_update.update_sms');
	...
	Route::post('/frontend_settings/home/campaign-link', 'HomeController@campaign_link_store')->name('campaign_link.store');
	...
	Route::group(['prefix' => 'frontend_settings'], function(){
		...
		Route::get('/home_categories/edit-category/{id}', 'HomeCategoryController@edithomecategory')->name('home_category.edit');
		Route::post('/home_categories/edit-category/{id}', 'HomeCategoryController@updatehomecategory')->name('home_categories.update_category');
	});
	...
	Route::get('/presale-orders', 'OrderController@admin_presale_orders')->name('presale.orders.index.admin');
	Route::get('/orders-seller', 'OrderController@admin_orders_seller')->name('orders.index.seller');
	Route::get('/seller-order/{id}/show', 'OrderController@seller_show')->name('seller_orders.show');
	...
	Route::post('/shipping_configuration_custom/update', 'BusinessSettingsController@shipping_configuration_custom')->name('shipping_configuration_custom.update');
