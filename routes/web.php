...
Route::get('/campaign-list', 'HomeController@flash_deal_list')->name('flash_deal_list');


Route::post('/language', 'LanguageController@changeLanguage')->name('language.change');
Route::post('/currency', 'CurrencyController@changeCurrency')->name('currency.change');

Route::post('/users/registration', 'HomeController@user_registration')->name('user.user_register');
...
Route::get('/pre-sale', 'HomeController@pre_sale')->name('pre_sale');
...
Route::group(['middleware' => ['user','unbanned']], function(){
	...
	Route::post('/flash_deals/seller/{id}', 'FlashDealController@update_seller_product')->name('flash_deals.update_seller');
	Route::get('/flash_deals/seller/{id}', 'FlashDealController@edit_seller')->name('flash_deals.edit_seller');
	Route::post('/flash_deals/supplier_product_discount_edit', 'FlashDealController@supplier_product_discount_edit')->name('flash_deals.supplier_product_discount_edit');
});
...
Route::group(['middleware' => ['auth']], function(){
	...
	Route::get('/products/permanently-destroy/{id}', 'ProductController@permanently_destroy')->name('products.permanently_destroy');
	...
	Route::post('/products/update_approved', 'ProductController@update_approved')->name('products.update_approved');
	...
	Route::get('invoice-1/seller/{order_id}', 'InvoiceController@seller_invoice_download_1')->name('seller.invoice.download_1');
	...
	Route::post('/orders/update_delivery_status_1', 'OrderController@update_delivery_status_1')->name('orders.update_delivery_status_1');
    Route::post('/orders/update_payment_status_1', 'OrderController@update_payment_status_1')->name('orders.update_payment_status_1');
...
Route::get('/verification', 'HomeController@user_verification')->name('user.verification');
